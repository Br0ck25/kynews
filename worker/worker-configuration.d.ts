/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 374449bc04f5a91ce0acc447c2abb870)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		INGEST_QUEUE: Queue;
		AI: Ai;
		/** VAPID public key — set as a Worker var in wrangler.jsonc */
		VAPID_PUBLIC_KEY: string;
		/** VAPID private key — set as a Worker secret via `wrangler secret put VAPID_PRIVATE_KEY` */
