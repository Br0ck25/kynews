...
export const NATIONAL_WIRE_OVERRIDE_RE = /\b(?:washington\s*[-—–]\s*|new\s+york\s*[-—–]\s*|atlanta\s*[-—–]\s*|charlotte\s*[-—–]\s*|nashville\s*[-—–]\s*|chicago\s*[-—–]\s*|los\s+angeles\s*[-—–]\s*|houston\s*[-—–]\s*|dallas\s*[-—–]\s*|miami\s*[-—–]\s*|denver\s*[-—–]\s*|phoenix\s*[-—–]\s*|seattle\s*[-—–]\s*|boston\s*[-—–]\s*|detroit\s*[-—–]\s*|minneapolis\s*[-—–]\s*|st\.\s*louis\s*[-—–]\s*|kansas\s+city\s*[-—–]\s*|las\s+vegas\s*[-—–]\s*|san\s+francisco\s*[-—–]\s*|san\s+diego\s*[-—–]\s*|portland\s*[-—–]\s*|sacramento\s*[-—–]\s*|salt\s+lake\s+city\s*[-—–]\s*|indianapolis\s*[-—–]\s*|columbus,?\s+ohio\s*[-—–]\s*|cleveland\s*[-—–]\s*|pittsburgh\s*[-—–]\s*|richmond,?\s+va\s*[-—–]\s*|raleigh\s*[-—–]\s*|jackson,?\s+miss\s*[-—–]\s*|montgomery,?\s+ala\s*[-—–]\s*|tallahassee\s*[-—–]\s*|little\s+rock\s*[-—–]\s*|oklahoma\s+city\s*[-—–]\s*|baton\s+rouge\s*[-—–]\s*|new\s+orleans\s*[-—–]\s*|(?:ap|reuters|afp)\s*[-—–]\s*|the\s+associated\s+press\s*[-—–]|nbc\s+news\s*[-—–]|cnn\s*[-—–]|abc\s+news\s*[-—–]|cbs\s+news\s*[-—–]|fox\s+news\s*[-—–]|dubai\s*[-—–]\s*united\s+arab|from\s+(?:new\s+york|washington|london|dubai|tel\s+aviv|jerusalem|paris|berlin|beijing|moscow|tokyo)|\(anf(?:\/gray\s+news)?\)\s*[-—–]?\s*|\(gray\s+news\)\s*[-—–]?\s*|\(nexstar\s+media\s+wire\)\s*[-—–]?\s*|\(cnn\s+newsource\)\s*[-—–]?\s*)/i;
