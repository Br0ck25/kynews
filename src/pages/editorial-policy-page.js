...
export default function EditorialPolicyPage() {
  ...
  React.useEffect(() => {
    const title = "Editorial Policy — Local KY News";
    ...
    // machine-readable AI disclosure for llms.txt and search engines
    const disclosureSchema = {
      "@context": "https://schema.org",
      "@type": "CreativeWork",
      name: "AI Disclosure",
      description:
        "Summaries on this site are generated by artificial intelligence under strict editorial rules and are always labeled as summaries of original reporting.",
      url: `${window.location.origin}/editorial-policy#ai-disclosure`,
      author: { "@type": "Organization", name: "Local KY News" },
    };
    let ld = document.getElementById("json-ld-ai-disclosure");
    if (!ld) {
      ld = document.createElement("script");
      ld.type = "application/ld+json";
      ld.id = "json-ld-ai-disclosure";
      document.head.appendChild(ld);
    }
    ld.textContent = JSON.stringify(disclosureSchema);
  }, []);
  ...
  return (
    <div className={classes.root}>
      ...
      {/* AI Summarization */}
      <Box className={classes.section} id="ai-disclosure">
        <Typography variant="h5" component="h2" gutterBottom style={{ fontWeight: 700 }}>
          AI Disclosure
        </Typography>
        <Divider style={{ marginBottom: 16 }} />
        <Typography variant="body1" paragraph>
          We use artificial intelligence to generate the summaries shown on this
          site. Each source article is processed by a model under strict rules that
          forbid adding new information, opinion, or speculation. Summaries are
          clearly labeled and always linked back to the original reporting. See the
          following section for details about our AI summarization methodology.
        </Typography>
      </Box>
      <Box className={classes.section}>
        <Typography variant="h5" component="h2" gutterBottom style={{ fontWeight: 700 }}>
