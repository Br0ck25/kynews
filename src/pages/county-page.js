...
export default function CountyPage({ countySlugProp = null, onClose = null, infoType = null }) {
      ...
      utilities: (
        <>
          ...
          <Typography variant="body2" paragraph>
            ...
            Website: <a href="https://www.kentuckypower.com/">kentuckypower.com</a>
          </Typography>
          <Typography variant="body2" paragraph>
            ...
            Website: <a href="https://www.cumberlandvalley.coop/">cumberlandvalley.coop</a>
          </Typography>
          <Typography variant="body2" paragraph>
          ...
          <Typography variant="body2" paragraph>
            ...
            Website: <a href="https://www.doxo.com/u/biller/hyden-leslie-county-water-district-19AAD20">
              doxo profile
            </a>
          </Typography>
  ...
  return (
    <div className={classes.root}>
      ...
      {/* navigation buttons for counties with extra info */}
